import {axiosG, axiosK, axiosM,axiosA,axiosJ,axiosF,axiosU} from '../../index'
...
export const passwordEditApi = data => axiosJ(passwordEdit, data)
export const stuAddApi = data => axiosK(stuAdd, data)
export const stuChangeApi = data => axiosM(stuChange, data)
export const stuInfoEditApi = data => axiosU(stuInfoEdit, data)
